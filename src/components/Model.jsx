...
const Model = () => {
    ...
    return (
        <section className='common-pdding'>
            <div className="screen-max-width">
                <h1 id='heading' className='section-heading mt-20'>
                    Take closer look.
                </h1>
                <div className="flex flex-col items-center mt-5">
                    <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relstive">
                        <ModelView index={1} groupRef={small} gsapType={'view1'} controlRef={cameraControlSmall} setRotation={setSmallRotation} item={model} size={size} />
                        <ModelView index={2} groupRef={large} gsapType={'view2'} controlRef={cameraControlLarge} setRotation={setLargeRotation} item={model} size={size} />
